...
const SEED = {
  ...
  songs: [
    { id: uuidv4(), title: 'Lucid Dream', role: 'Original • Singer / Songwriter', year: 2019, language: 'English', genre: 'Original', desc: 'First single, produced by A.R. Rahman’s KM Conservatory as part of The Indie Earth’s Indie100 2019. Released by Vermilion Records, USA.', image: '/vaja/vaja-004.jpg', tag: 'Vermilion Records, USA', audioUrl: '', videoUrl: '', streamUrl: '' },
    { id: uuidv4(), title: 'Mahi Way', role: 'Tribute • Chennai Super Kings', year: 2024, language: 'Hindi / Tamil', genre: 'Tribute', desc: 'An official collaboration with the Chennai Super Kings — a tribute song for M.S. Dhoni. Featured on the official CSK Instagram & YouTube channel.', image: '/vaja/vaja-021.jpg', tag: 'CSK × Vaja', audioUrl: '', videoUrl: 'https://www.youtube.com/watch?v=', streamUrl: '' },
    { id: uuidv4(), title: 'Game On — Richo Rich', role: 'Playback / Featured', year: 2023, language: 'Tamil', genre: 'Film', desc: 'Featured vocalist for the Tamil release of “Game On — Richo Rich”.', image: '/vaja/vaja-063.jpg', tag: 'Playback', audioUrl: '', videoUrl: '', streamUrl: '' },
    { id: uuidv4(), title: 'Game On — Un Mooche', role: 'Playback / Featured', year: 2023, language: 'Tamil', genre: 'Film', desc: 'Featured vocalist for “Un Mooche” from the Game On series.', image: '/vaja/vaja-028.jpg', tag: 'Playback', audioUrl: '', videoUrl: '', streamUrl: '' },
    { id: uuidv4(), title: 'Thanimai Athu Varama', role: 'Original • Singer', year: 2022, language: 'Tamil', genre: 'Original', desc: 'An intimate Tamil original that captures solitude, longing and hope.', image: '/vaja/vaja-027.jpg', tag: 'Original', audioUrl: '', videoUrl: '', streamUrl: '' },
